...
MechAura lets you play any sound when you type or click. Use it for education, presentations, gaming, or just for fun.
...
1. Download from [Releases](https://github.com/mukul9897/MechAura/releases)
2. Run installer
3. Select soundpacks
